# Contributing to omniosce-packer

First and foremost, thank you! We appreciate that you want to contribute to omniosce-packer, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for omniosce-packer**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for omniosce-packer:

- star the [project](https://github.com/STORViX/omniosce-packer)
- tweet your support for omniosce-packer
...
- **version**: (required) please note the version of omniosce-packer are you using
...
The original poster or the maintainers of omniosce-packer may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/omniosce-packer
